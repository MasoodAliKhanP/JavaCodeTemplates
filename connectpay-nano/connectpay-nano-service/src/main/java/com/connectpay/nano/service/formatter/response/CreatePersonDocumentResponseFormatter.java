...
@Component
public class CreatePersonDocumentResponseFormatter implements ResponseDataFormatter {
	private static Logger logger = LogManager.getLogger(CreatePersonDocumentResponseFormatter.class);
	...
	public <T> void handleResponse(T tTypeObject, Map<String, String> responseMap) {
		...
		LogUtil.log(logger, "nano add corporate address response ==  " + supplierResponse);

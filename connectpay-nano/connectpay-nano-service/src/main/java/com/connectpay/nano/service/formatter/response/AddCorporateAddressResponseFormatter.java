...
@Component
public class AddCorporateAddressResponseFormatter implements ResponseDataFormatter {
	private static Logger logger = LogManager.getLogger(AddCorporateAddressResponseFormatter.class);

...
@Component
public class CompletePersonCreationResponseFormatter implements ResponseDataFormatter {
	...
	public <T> void handleResponse(T tTypeObject, Map<String, String> responseMap) {
		...
		LogUtil.log(logger, "nano complete person response ==  " + supplierResponse);

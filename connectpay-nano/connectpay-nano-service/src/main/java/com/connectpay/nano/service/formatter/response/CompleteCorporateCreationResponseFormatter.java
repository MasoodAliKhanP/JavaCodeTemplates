...
@Component
public class CompleteCorporateCreationResponseFormatter implements ResponseDataFormatter {
	private static Logger logger = LogManager.getLogger(CompletePersonCreationResponseFormatter.class);
	...
	public <T> void handleResponse(T tTypeObject, Map<String, String> responseMap) {
		...
		LogUtil.log(logger, "nano complete corporate response ==  " + supplierResponse);

...
@Component
public class CreatePersonContactResponseFormatter implements ResponseDataFormatter {
	private static Logger logger = LogManager.getLogger(CreatePersonContactResponseFormatter.class);
